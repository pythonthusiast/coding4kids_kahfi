...
def main():
    ...
    pygame.display.set_caption('kahfi')
...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('kahfi!', True, WHITE, DARKGREEN)
    titleSurf2 = titleFont.render('keren!', True, GREEN)
...
def drawScore(score):
    scoreSurf = BASICFONT.render('nilai: %s' % (score), True, WHITE)
